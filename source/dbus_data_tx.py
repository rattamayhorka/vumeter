...
def main():
    ...
    def send_serial(dato_envio):
        ...
        print("enviando datos por puerto serial con unicode")  # Imprime la salida
    ...
    def send_serial_sin_unicode(dato_envio):
        print("enviando datos por puerto serial sin codificar")  # Imprime la salida
...
def run_as_daemon():
    daemon = Daemonize(app="vumeter", pid="/tmp/vumeter", action=main)
    daemon.start()
